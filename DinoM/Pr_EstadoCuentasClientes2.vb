...
Public Class Pr_EstadoCuentasClientes2
...
#Region "METODOS PRIVADOS"
    ...
    Private Sub _prCargarReporte()
        Try
            ...
            Dt1Estado = L_prListarEstadoCuentasCliente2(tbCodigoCliente.Text, tbFechaI.Value.ToString("yyyy/MM/dd"), tbFechaF.Value.ToString("yyyy/MM/dd"))
    ...
    Private Sub P_ArmarDatos()
        ...
        f.Item(2) = tbFechaI.Value.ToString("dd/MM/yyyy")
        f.Item(3) = 0
